import { useSSRContext, mergeProps, ref, watch, withCtx, createVNode, openBlock, createBlock, toDisplayString, unref, createTextVNode, createCommentVNode, withModifiers, withDirectives, vModelText, Fragment, renderList, renderSlot, createSSRApp, h } from "vue";
import { ssrRenderAttrs, ssrRenderSlot, ssrRenderComponent, ssrInterpolate, ssrRenderAttr, ssrRenderList, ssrRenderClass, ssrRenderStyle } from "vue/server-renderer";
import { Link, Head, useForm, router, createInertiaApp } from "@inertiajs/vue3";
...
const Container = /* @__PURE__ */ _export_sfc(_sfc_main$r, [["ssrRender", _sfc_ssrRender$3]]);
const _sfc_main$q = {};
...
const Content = /* @__PURE__ */ _export_sfc(_sfc_main$q, [["ssrRender", _sfc_ssrRender$2]]);
const _sfc_main$p = {};
...
const Carousel = /* @__PURE__ */ _export_sfc(_sfc_main$p, [["ssrRender", _sfc_ssrRender$1]]);
...
const CarouselSlide = /* @__PURE__ */ _export_sfc(_sfc_main$o, [["__scopeId", "data-v-97526194"]]);
const slidesLen = 9;
const interval = 400;
const _sfc_main$n = {
  __name: "MainCarousel",
...
const SearchTyre = /* @__PURE__ */ _export_sfc(_sfc_main$m, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-8a5c86aa"]]);
const _sfc_main$l = {
  __name: "OurServices",
  __ssrInlineRender: true,
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(Container, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="flex md:flex-row flex-col md:pt-12 sm:pt-6 xl:h-[340px] lg:h-[300px] md:h-[280px]"${_scopeId}><div class="xl:w-[70%] md:w-[65%] w-full"${_scopeId}>`);
            _push2(ssrRenderComponent(_sfc_main$n, { location: __props.location }, null, _parent2, _scopeId));
            _push2(`</div><div class="xl:w-[30%] md:w-[35%] w-full"${_scopeId}>`);
            _push2(ssrRenderComponent(SearchTyre, null, null, _parent2, _scopeId));
            _push2(`</div></div>`);
            _push2(ssrRenderComponent(_sfc_main$l, null, null, _parent2, _scopeId));
            ...
            return [
              createVNode("div", { class: "flex md:flex-row flex-col md:pt-12 sm:pt-6 xl:h-[340px] lg:h-[300px] md:h-[280px]" }, [
                createVNode("div", { class: "xl:w-[70%] md:w-[65%] w-full" }, [
                  createVNode(_sfc_main$n, { location: __props.location }, null, 8, ["location"])
                ]),
                createVNode("div", { class: "xl:w-[30%] md:w-[35%] w-full" }, [
                  createVNode(SearchTyre)
                ])
...
const app = "";
const Header_vue_vue_type_style_index_0_scoped_fa8634ae_lang = "";
const _sfc_main$6 = {
  __name: "Header",
  __ssrInlineRender: true,
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(Container, mergeProps({ class: "select-none relative flex md:flex-row flex-col items-center md:justify-between justify-center md:pb-5 pb-3" }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="sm:w-[300px] w-[250px]" data-v-fa8634ae${_scopeId}>`);
            _push2(ssrRenderComponent(unref(Link), { href: "/" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<img src="/assets/images/main/tyresanywhere.webp" srcset="/assets/images/main/tyresanywhere.webp 300w,
							/assets/images/main/tyresanywhere-250.webp 250w" sizes="(max-width: 576px) 250px, 300px" height="112" width="300" alt="Tyres Anywhere Group" data-v-fa8634ae${_scopeId2}>`);
                } else {
                  return [
                    createVNode("img", {
                      src: "/assets/images/main/tyresanywhere.webp",
                      srcset: "/assets/images/main/tyresanywhere.webp 300w,\n							/assets/images/main/tyresanywhere-250.webp 250w",
                      sizes: "(max-width: 576px) 250px, 300px",
                      height: "112",
                      width: "300",
                      alt: "Tyres Anywhere Group"
                    })
                  ];
                }
              }),
            ...
            _push2(`</div><div class="md:absolute relative md:left-1/2 md:top-1/2 bottom-auto md:-translate-y-1/2 md:-translate-x-1/2 md:mt-0 mt-3" data-v-fa8634ae${_scopeId}><p class="xl:text-4xl lg:text-3xl lg:block md:hidden font-semibold whitespace-nowrap" data-v-fa8634ae${_scopeId}>WE COME TO <span class="text-wheelfit-300" data-v-fa8634ae${_scopeId}>YOU</span></p><div class="cover absolute top-0 bottom-0 right-0 h-full w-full bg-white z-10" data-v-fa8634ae${_scopeId}></div></div><div class="md:block hidden font-montserrat" data-v-fa8634ae${_scopeId}><p class="mb-1 text-3xl font-extrabold" data-v-fa8634ae${_scopeId}>Need HELP?</p><span class="font-extrabold text-xl" data-v-fa8634ae${_scopeId}> CALL US ON <a class="text-xl text-wheelfit-300 text-shadow" href="tel:07442980101" title="Phone Number" data-v-fa8634ae${_scopeId}>07442 980101</a></span></div>`);
          } else {
            return [
              ...
              createVNode("div", { class: "md:absolute relative md:left-1/2 md:top-1/2 bottom-auto md:-translate-y-1/2 md:-translate-x-1/2 md:mt-0 mt-3" }, [
                createVNode("p", { class: "xl:text-4xl lg:text-3xl lg:block md:hidden font-semibold whitespace-nowrap" }, [
                  createTextVNode("WE COME TO "),
                  createVNode("span", { class: "text-wheelfit-300" }, "YOU")
                ]),
                createVNode("div", { class: "cover absolute top-0 bottom-0 right-0 h-full w-full bg-white z-10" })
              ]),
              createVNode("div", { class: "md:block hidden font-montserrat" }, [
                createVNode("p", { class: "mb-1 text-3xl font-extrabold" }, "Need HELP?"),
                createVNode("span", { class: "font-extrabold text-xl" }, [
                  createTextVNode(" CALL US ON "),
                  createVNode("a", {
                    class: "text-xl text-wheelfit-300 text-shadow",
                    href: "tel:07442980101",
                    title: "Phone Number"
                  }, "07442 980101")
                ])
...
const Header = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["__scopeId", "data-v-fa8634ae"]]);
const _sfc_main$5 = {
...
_sfc_main$5.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Shared/NavbarDropdown.vue");
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(unref(Link), mergeProps({
        href: __props.href,
        class: "lg:text-sm text-[13px] text-gray-100 hover:bg-secondary-400 lg:px-5 px-3 lg:py-3.5 py-2 uppercase block transition duration-150 ease-in-out"
      }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
...
_sfc_main$3.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Shared/NavLinkMob.vue");
  return _sfc_setup$3 ? _sfc_setup$3(props, ctx) : void 0;
};
const Navbar_vue_vue_type_style_index_0_scoped_e9cb2f52_lang = "";
const _sfc_main$2 = {
  __name: "Navbar",
  __ssrInlineRender: true,
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<nav${ssrRenderAttrs(mergeProps({ class: "select-none shadow-[0_0px_10px_0px_rgba(0,0,0,0.8)] bg-secondary-500 relative flex items-center justify-start" }, _attrs))} data-v-e9cb2f52>`);
      _push(ssrRenderComponent(Container, { class: "md:block hidden relative" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="flex items-center" data-v-e9cb2f52${_scopeId}><ul class="flex flex-row list-none" data-v-e9cb2f52${_scopeId}><li data-v-e9cb2f52${_scopeId}>`);
            _push2(ssrRenderComponent(_sfc_main$4, { href: "/" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="currentColor" viewBox="0 0 512 512" data-v-e9cb2f52${_scopeId2}><path d="M261.56,101.28a8,8,0,0,0-11.06,0L66.4,277.15a8,8,0,0,0-2.47,5.79L63.9,448a32,32,0,0,0,32,32H192a16,16,0,0,0,16-16V328a8,8,0,0,1,8-8h80a8,8,0,0,1,8,8l0,136a16,16,0,0,0,16,16h96.06a32,32,0,0,0,32-32l0-165.06a8,8,0,0,0-2.47-5.79Z" data-v-e9cb2f52${_scopeId2}></path><path d="M490.91,244.15l-74.8-71.56,0-108.59a16,16,0,0,0-16-16h-48a16,16,0,0,0-16,16l0,32L278.19,40.62C272.77,35.14,264.71,32,256,32h0c-8.68,0-16.72,3.14-22.14,8.63L21.16,244.13c-6.22,6-7,15.87-1.34,22.37A16,16,0,0,0,43,267.56L250.5,69.28a8,8,0,0,1,11.06,0L469.08,267.56a16,16,0,0,0,22.59-.44C497.81,260.76,497.3,250.26,490.91,244.15Z" data-v-e9cb2f52${_scopeId2}></path></svg>`);
                } else {
                  return [
                    (openBlock(), createBlock("svg", {
                      xmlns: "http://www.w3.org/2000/svg",
                      ...
                      createVNode("path", { d: "M261.56,101.28a8,8,0,0,0-11.06,0L66.4,277.15a8,8,0,0,0-2.47,5.79L63.9,448a32,32,0,0,0,32,32H192a16,16,0,0,0,16-16V328a8,8,0,0,1,8-8h80a8,8,0,0,1,8,8l0,136a16,16,0,0,0,16,16h96.06a32,32,0,0,0,32-32l0-165.06a8,8,0,0,0-2.47-5.79Z" }),
                      createVNode("path", { d: "M490.91,244.15l-74.8-71.56,0-108.59a16,16,0,0,0-16-16h-48a16,16,0,0,0-16,16l0,32L278.19,40.62C272.77,35.14,264.71,32,256,32h0c-8.68,0-16.72,3.14-22.14,8.63L21.16,244.13c-6.22,6-7,15.87-1.34,22.37A16,16,0,0,0,43,267.56L250.5,69.28a8,8,0,0,1,11.06,0L469.08,267.56a16,16,0,0,0,22.59-.44C497.81,260.76,497.3,250.26,490.91,244.15Z" })
                    ]))
                  ];
                }
              }),
            ...
            _push2(`</li><li data-v-e9cb2f52${_scopeId}>`);
            ...
            _push2(`</li><li data-v-e9cb2f52${_scopeId}><a href="https://tyresanywhere.com/search-tyres" class="lg:text-sm text-[13px] text-gray-100 hover:bg-secondary-400 lg:px-5 px-3 lg:py-3.5 py-2 uppercase block transition duration-150 ease-in-out" title="Search Tyres" data-v-e9cb2f52${_scopeId}>Search Tyres</a></li><li data-v-e9cb2f52${_scopeId}>`);
            _push2(ssrRenderComponent(_sfc_main$4, {
              href: "/tyres",
            ...
            _push2(ssrRenderComponent(_sfc_main$5, null, {
              trigger: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<span class="cursor-pointer flex items-center lg:text-sm text-[13px] text-gray-100 hover:bg-secondary-400 lg:px-5 px-3 lg:py-3.5 py-2 uppercase block transition duration-150 ease-in-out" data-v-e9cb2f52${_scopeId2}> Other Services <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 ml-1" viewBox="0 0 20 20" fill="currentColor" data-v-e9cb2f52${_scopeId2}><path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd" data-v-e9cb2f52${_scopeId2}></path></svg></span>`);
                } else {
                  return [
                    createVNode("span", { class: "cursor-pointer flex items-center lg:text-sm text-[13px] text-gray-100 hover:bg-secondary-400 lg:px-5 px-3 lg:py-3.5 py-2 uppercase block transition duration-150 ease-in-out" }, [
              ...
              content: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="flex flex-row m-0" data-v-e9cb2f52${_scopeId2}><div class="lg:w-1/4 w-1/3 px-3" data-v-e9cb2f52${_scopeId2}><p class="pl-4 text-2xl font-light" data-v-e9cb2f52${_scopeId2}>Other Services</p><hr class="my-2 border-t-2 border-wheelfit-300/30" data-v-e9cb2f52${_scopeId2}><div class="space-y-2" data-v-e9cb2f52${_scopeId2}>`);
                  _push3(ssrRenderComponent(unref(Link), {
                  ...
                  _push3(ssrRenderComponent(unref(Link), {
                    class: "block text-sm w-full py-1 px-4 clear-both text-gray-800 hover:bg-gray-200",
                    href: "/tyre-replacement",
                    title: "Tyre Replacement"
                  }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`Tyre Replacement`);
                      } else {
                        return [
                          createTextVNode("Tyre Replacement")
                        ];
                      }
                    }),
                    _: 1
                  ...
                  _push3(`</div></div><div class="lg:w-1/4 w-1/3 px-3" data-v-e9cb2f52${_scopeId2}><p class="pl-4 text-2xl font-light" data-v-e9cb2f52${_scopeId2}>Book a Tyre</p><hr class="my-2 border-t-2 border-wheelfit-300/30" data-v-e9cb2f52${_scopeId2}><div class="space-y-2" data-v-e9cb2f52${_scopeId2}>`);
                  _push3(ssrRenderComponent(unref(Link), {
                    class: "block text-sm w-full py-1 px-4 clear-both text-gray-800 hover:bg-gray-200",
                    href: "/search-tyres",
                    title: "Search Tyres"
                  ...
                  _push3(`</div></div><div class="lg:w-1/4 w-1/3 lg:ml-auto px-3" data-v-e9cb2f52${_scopeId2}><p class="pl-4 text-2xl font-light" data-v-e9cb2f52${_scopeId2}>Need Help?</p><hr class="my-2 border-t-2 border-wheelfit-300/30" data-v-e9cb2f52${_scopeId2}><div class="space-y-2" data-v-e9cb2f52${_scopeId2}>`);
                  _push3(ssrRenderComponent(unref(Link), {
                    class: "block text-sm w-full py-1 px-4 clear-both text-gray-800 hover:bg-gray-200",
                    href: "/contact-us",
                    title: "Contact Us"
                  ...
                  _push3(`<a class="block text-sm w-full py-1 px-4 clear-both text-gray-800 hover:bg-gray-200" href="tel:07442980101" data-v-e9cb2f52${_scopeId2}> 07442 980101 </a></div></div></div>`);
                } else {
                  return [
      ...
      _push(`<div class="md:hidden block w-full flex items-center justify-center relative h-[3.5rem]" data-v-e9cb2f52><a class="flex items-center color-anim" href="tel:07442 980101" data-v-e9cb2f52><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-1" viewBox="0 0 20 20" fill="currentColor" data-v-e9cb2f52><path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z" data-v-e9cb2f52></path></svg><span class="text-xl" data-v-e9cb2f52>07442 980101</span></a><button class="menu-btn h-10 w-10 bg-wheelfit-500 hover:bg-wheelfit-400 text-white border-0 outline-0 text-xl flex items-center justify-center transition duration-150 absolute right-2.5 top-1/2 -translate-y-1/2" data-v-e9cb2f52><svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" viewBox="0 0 20 20" fill="currentColor" data-v-e9cb2f52><path fill-rule="evenodd" d="M3 5a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zM3 10a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zM3 15a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1z" clip-rule="evenodd" data-v-e9cb2f52></path></svg></button></div><div style="${ssrRenderStyle(mobileNavShow.value ? null : { display: "none" })}" class="md:hidden block mobile-nav w-72 fixed top-0 left-0 z-50" data-v-e9cb2f52><div class="h-screen overflow-y-scroll" data-v-e9cb2f52><button class="w-full flex items-center justify-center h-14 bg-[#ebebeb] text-wheelfit-600 text-lg" type="button" data-v-e9cb2f52><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-1" viewBox="0 0 20 20" fill="currentColor" data-v-e9cb2f52><path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd" data-v-e9cb2f52></path></svg> CLOSE </button><div class="flex flex-col" data-v-e9cb2f52>`);
      _push(ssrRenderComponent(_sfc_main$3, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-1" viewBox="0 0 20 20" fill="currentColor" data-v-e9cb2f52${_scopeId}><path d="M10.707 2.293a1 1 0 00-1.414 0l-7 7a1 1 0 001.414 1.414L4 10.414V17a1 1 0 001 1h2a1 1 0 001-1v-2a1 1 0 011-1h2a1 1 0 011 1v2a1 1 0 001 1h2a1 1 0 001-1v-6.586l.293.293a1 1 0 001.414-1.414l-7-7z" data-v-e9cb2f52${_scopeId}></path></svg> HOME `);
          } else {
            return [
              (openBlock(), createBlock("svg", {
                xmlns: "http://www.w3.org/2000/svg",
      ...
      _push(`<a href="https://tyresanywhere.com/search-tyres" title="Search Tyres" class="border-b w-full py-4 pl-4 border-[#ebebeb] text-sm text-gray-400" data-v-e9cb2f52>Search Tyres</a>`);
      _push(ssrRenderComponent(_sfc_main$3, {
        href: "/tyres",
        component: "Tyres",
        title: "Tyres",
      ...
      _push(`<div class="w-full py-4 pl-4 border-b border-[#ebebeb] text-sm text-gray-400" data-v-e9cb2f52><span class="flex items-center" data-v-e9cb2f52> Other Services <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 ml-1" viewBox="0 0 20 20" fill="currentColor" data-v-e9cb2f52><path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd" data-v-e9cb2f52></path></svg></span><div style="${ssrRenderStyle(otherServicesOpen.value ? null : { display: "none" })}" class="flex flex-col space-y-2 mt-2" data-v-e9cb2f52>`);
      _push(ssrRenderComponent(_sfc_main$3, {
        href: "/mobile-tyre-repair",
      ...
      _push(ssrRenderComponent(_sfc_main$3, {
        href: "/tyre-replacement",
        component: "TyreReplacement",
        title: "Tyre Replacement",
        class: "border-l-2 border-dotted"
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`Tyre Replacement`);
          } else {
            return [
              createTextVNode("Tyre Replacement")
            ];
      ...
      _push(ssrRenderComponent(_sfc_main$3, {
        href: "/puncture-repair",
        component: "PunctureRepair",
        title: "Puncture Repair",
        class: "border-l-2 border-dotted"
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`Puncture Repair`);
          } else {
            return [
              createTextVNode("Puncture Repair")
            ];
      ...
      _push(ssrRenderComponent(_sfc_main$3, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<a data-v-e9cb2f52${_scopeId}>Contact Us</a>`);
          } else {
            return [
...
_sfc_main$2.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Shared/Navbar.vue");
  return _sfc_setup$2 ? _sfc_setup$2(props, ctx) : void 0;
};
const Navbar = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-e9cb2f52"]]);
const _sfc_main$1 = {
  __name: "Footer",
  __ssrInlineRender: true,
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(Container, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="grid grid-cols-3 md:gap-x-12 md:gap-y-0 gap-y-8 md:px-0 px-8 py-10"${_scopeId}><div class="md:col-span-1 col-span-3"${_scopeId}><p class="text-xl tracking-wide mb-2 text-white uppercase"${_scopeId}>Tyres Anywhere</p><p class="mt-6 text-gray-500 text-sm"${_scopeId}> Having a punctured tyre can be a headache, especially on the middle of the motorway. That&#39;s why at <b class="text-gray-400"${_scopeId}>Tyres Anywhere</b>, we bring our mobile service right to your vehicle, whether you&#39;re at home, work or on the hard shoulder. </p></div><div class="md:col-span-1 col-span-3"${_scopeId}><p class="text-xl tracking-wide mb-2 text-white"${_scopeId}>SERVICES</p><div class="space-y-3 flex flex-col items-start"${_scopeId}>`);
            _push2(ssrRenderComponent(unref(Link), {
            ...
            _push2(`<a class="text-sm text-gray-500 underline hover:text-gray-300" href="https://tyresanywhere.com/search-tyres" title="Book Tyres"${_scopeId}>Search Tyres</a></div></div><div class="md:col-span-1 col-span-3"${_scopeId}><p class="text-xl tracking-wide mb-2 text-white"${_scopeId}>HELP</p><div class="space-y-3 flex flex-col items-start"${_scopeId}>`);
            _push2(ssrRenderComponent(unref(Link), {
              class: "text-sm text-gray-500 underline hover:text-gray-300",
              href: "/contact-us",
              title: "Contact Us"
            ...
            return [
              createVNode("div", { class: "grid grid-cols-3 md:gap-x-12 md:gap-y-0 gap-y-8 md:px-0 px-8 py-10" }, [
                createVNode("div", { class: "md:col-span-1 col-span-3" }, [
                  createVNode("p", { class: "text-xl tracking-wide mb-2 text-white uppercase" }, "Tyres Anywhere"),
                  createVNode("p", { class: "mt-6 text-gray-500 text-sm" }, [
                    ...
                    createVNode("b", { class: "text-gray-400" }, "Tyres Anywhere"),
      ...
      _push(ssrRenderComponent(Container, { class: "flex lg:flex-row lg:space-y-0 space-y-2 flex-col items-center justify-between py-5" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<p class="text-sm text-center text-gray-500"${_scopeId}>© 2022 Tyres Anywhere | All Rights Reserved</p><p class="text-gray-300 text-center text-sm"${_scopeId}>Website by: <a class="text-white hover:underline" href="https://skelop.com" target="_blank" rel="noreferrer"${_scopeId}>SKELOP Website Design &amp; Development</a></p>`);
          } else {
            return [
              createVNode("p", { class: "text-sm text-center text-gray-500" }, "© 2022 Tyres Anywhere | All Rights Reserved"),
