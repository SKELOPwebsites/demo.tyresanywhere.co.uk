    ...
    <div class="flex flex-col sm:flex-row h-full bg-wheelfit-300 p-10 mx-8 sm:mx-20 gap-8 mt-24 sm:mt-32 reveal">
        ...
        class="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
            <div class="bg-white p-5 rounded-lg w-2/3 font-rubik flex flex-col items-center">
                <h2 class="uppercase pt-5 text-3xl font-normal mb-4 text-wheelfit-300">How to Check Your Vehicle's Tyre Size</h2>
                <p class="text-center font-light text-gray-600 px-5">To find your car's tyre size, check the sidewall of your current tyres. You'll see three numbers that represent the width, profile, and rim size (e.g., 205/55 R16). You can also find this information in your vehicle's handbook or on a sticker inside the door jam or fuel cap door. Make sure to match these numbers when buying new tyres for the best fit.</p>
                <img
        ...
        <div class="flex-1 flex flex-col bg-white p-2 sm:p-6 rounded-md shadow-lg">
            ...
            <a href="https://tyresanywhere.com/search-tyres" class="text-white bg-wheelfit-300 w-auto mx-5 mt-4 sm:mt-8 lg:h-12 h-10 rounded-lg cursor-pointer flex items-center justify-center hover:bg-wheelfit-400 transition duration-300 hover:scale-105">
...
<style scoped>
.text-shadow {
    text-shadow: 0 4px 3px rgba(255,102,102,0.3), 0 8px 13px rgba(255,102,102,0.2), 0 18px 23px rgba(255,102,102,0.1), 0 24px 29px rgba(255,102,102,0.05);
}
