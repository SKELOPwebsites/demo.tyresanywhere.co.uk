    ...
    <div class="lg:py-20 py-10 lg:mt-0 sm:mt-6 mt-4 flex items-center relative">
        <div class="lg:w-full w-full font-exo">
            ...
            <div class="relative z-10">
                <h3 class="xl:text-5xl text-4xl font-semibold mb-2 lg:text-black text-white lg:text-left text-center">Areas we Cover</h3>
                <p class="xl:text-lg lg:text-black text-white lg:text-left text-center">With over 100 mobile units, we serve nationwide</p>
