    ...
    <div class="mt-12 py-12 px-6 lg:p-0 flex items-start relative gap-10 reveal">
        <div class="lg:w-full w-full font-rubik">
            ...
            <div class="relative z-10">
                ...
                <p class="xl:text-xl text-lg lg:text-gray-500 text-white font-light lg:text-left text-center">With over 100 mobile units, we provide convenient tyre fitting services nationwide.</p>
