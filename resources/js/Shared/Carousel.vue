<template>
    <div class="flex flex-wrap-reverse md:flex-nowrap items-center justify-center gap-8 md:gap-16 pt-2 sm:pt-6 overflow-hidden w-full max-w-6xl mx-auto h-full">
        <div class="relative w-full md:w-1/2 lg:pr-12 w-full h-full flex flex-col text-center md:text-left">
            <!-- Text Swiper -->
            <Swiper
